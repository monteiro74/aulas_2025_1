# -*- coding: utf-8 -*-
# ==============================================================================
# Nome do Script: random_forest_classificacao.py - Classificacao com Random Forest
# Descrição: Este script aplica o algoritmo Random Forest ao dataset
# Autor: Nome do aluno
# Data de Criação: 
# Hora de Criação: 
#
...
df_report.to_csv("resultado_random_forest.csv", sep=';', index=True)

# Gráfico
disp = ConfusionMatrixDisplay.from_estimator(modelo, X_test, y_test)
plt.title("Matriz de Confusão - Random Forest")
plt.savefig("grafico_random_forest.png")
plt.close()
